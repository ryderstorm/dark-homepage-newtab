...
spec:
  subject_pattern: "repo:ryderstorm/shadow-tab:ref:refs/heads/main"
```
...
2. **Subject Pattern**: `repo:ryderstorm/shadow-tab:ref:refs/heads/main` ✅
...
- ✅ Subject pattern matches repository path (ryderstorm/shadow-tab)
